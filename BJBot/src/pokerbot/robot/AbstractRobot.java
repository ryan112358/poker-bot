...
import pokerbot.robot.img.Window;
import pokerbot.utils.Utils;

/**
 * This robot contains functions that other robots may find useful.
 */
public class AbstractRobot {
    ...
    public BufferedImage screenShot() {
        return robot.createScreenCapture(window.getScreenRect());
    }

    public BufferedImage screenShot(Rectangle r) {
        return robot.createScreenCapture(window.combine(r));
    }

    /**
     * Moves robot to a random location within the rectangle then clicks
     *
     * @param r
     */
